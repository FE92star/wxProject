...
Page({
  ...
  addData: function (fn) {
    ...
    if (this.data.hidden) {
      ...
      wx.request({
        url: 'http://tingapi.ting.baidu.com/v1/restserver/ting?type=2&method=baidu.ting.billboard.billList',
        data: {
          type: 1,
  ...
  playmusic: function (id, fn) {
    ...
    wx.request({
      url: 'http://tingapi.ting.baidu.com/v1/restserver/ting?type=2&method=baidu.ting.song.play',
      data: { songid: id },
      method: 'GET', // OPTIONS, GET, HEAD, POST, PUT, DELETE, TRACE, CONNECT
      // header: {}, // 设置请求的 header
      success: function (res) {
